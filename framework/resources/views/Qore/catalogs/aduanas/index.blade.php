...
@section('content')
        ...
        <div class="col-sm-8">
            <div class="panel panel-default">
                <div class="panel-body">
                    @include('Qore.catalogs.aduanas.tabs')
                </div>
            </div>

            <div class="panel panel-default">
                <div class="panel-body">
                    @include('Qore.catalogs.aduanas.grid')
                </div>
            </div>
        </div>
    ...
    {!! Form::open(['route' => ['qore.catalogs.aduana.destroy', ':ADUANA_ID'], 'method' => 'DELETE', 'id' => 'form_delete']) !!}
    {!! Form::close() !!}
@endsection
...
@section('scripts')
    ...
    $(".option-delete").click(function(e){
        ...
        var url = form.attr('action').replace(':ADUANA_ID', aduana);
