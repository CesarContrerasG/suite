...
@section('content')
        ...
        <div class="col-md-8">
            <div class="panel panel-default">
                <div class="panel-body">
                    @include('Qore.catalogs.claves_pedimento.tabs')
                </div>
            </div>

            <div class="panel panel-default">
                <div class="panel-body">
                    @include('Qore.catalogs.claves_pedimento.grid')
                </div>
            </div>
        </div>
    ...
    {!! Form::open(['route' => ['qore.catalogs.cpediments.destroy', ':CLAVE_ID'], 'method' => 'DELETE', 'id' => 'form_delete']) !!}
    {!! Form::close() !!}
@endsection
...
@section('scripts')
    ...
    $(".option-delete").click(function(e){
        ...
        var url = form.attr('action').replace(':CLAVE_ID', aduana);
