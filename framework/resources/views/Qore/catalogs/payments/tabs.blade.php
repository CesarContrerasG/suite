    ...
    <div class="tab-content">
        <div role="tabpanel" class="tab-pane fade in active" id="create">
            <div class="with-padding">
                <div class="row">
                    {!! Form::open(['route' => 'qore.catalogs.payments.store', 'method' => 'POST']) !!}
        ...
        <div role="tabpanel" class="tab-pane fade" id="upload">
            <div class="with-padding">
                <div class="row">
                    {!! Form::open(['route' => 'qore.catalogs.payments.import', 'method' => 'POST', 'files' => true]) !!}
                    <div class="col-md-12">
                    ...
                    {!! Form::close() !!}
                            <a href="{{ route('qore.catalogs.payments.layout') }}" class="btn btn-default btn-sm btn-round">descargar layout</a>
                            <a href="{{ route('qore.catalogs.payments.export') }}" class="btn btn-default btn-sm btn-round btn-round-warning">descargar información</a>
                        </div>
                    </div>
                </div>
            </div>
