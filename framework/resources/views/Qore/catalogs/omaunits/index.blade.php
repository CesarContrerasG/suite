        ...
        <div class="col-sm-8">
            <div class="panel panel-default">
                <div class="panel-body">
                    @include('Qore.catalogs.omaunits.tabs')
                </div>
            </div>
            <div class="panel panel-default">
                <div class="panel-body">
                    @include('Qore.catalogs.omaunits.grid')
                </div>
            </div>
        </div>
    </div>

    {!! Form::open(['route' => ['qore.catalogs.omaunits.destroy', ':UNIT_ID'], 'method' => 'DELETE', 'id' => 'form_delete']) !!}
    {!! Form::close() !!}
@endsection
...
@section('scripts')
    ...
    $(".option-delete").click(function(e){
        ...
        var url = form.attr('action').replace(':UNIT_ID', aduana);
