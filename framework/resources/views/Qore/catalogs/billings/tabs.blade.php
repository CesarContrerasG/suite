    ...
    <div class="tab-content">
        <div role="tabpanel" class="tab-pane fade in active" id="create">
            <div class="with-padding">
                <div class="row">
                    {!! Form::open(['route' => 'qore.catalogs.billings.store', 'method' => 'POST']) !!}
        ...
        <div role="tabpanel" class="tab-pane fade" id="upload">
            <div class="with-padding">
                <div class="row">
                    {!! Form::open(['route' => 'qore.catalogs.billings.import', 'method' => 'POST', 'files' => true]) !!}
                    <div class="col-md-12">
                    ...
                    {!! Form::close() !!}
                            <a href="{{ route('qore.catalogs.billings.layout') }}" class="btn btn-default btn-sm btn-round">Descargar Layout</a>
                            <a href="{{ route('qore.catalogs.billings.export') }}" class="btn btn-default btn-sm btn-round btn-round-warning">Descargar Información</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form_group text-right">
                            {!! Form::submit('Buscar Termino de Facturación', ['class' => 'btn btn-default btn-sm btn-round btn-round-success']) !!}
                        </div>
                    </div>
                    {!! Form::close() !!}
                </div>
