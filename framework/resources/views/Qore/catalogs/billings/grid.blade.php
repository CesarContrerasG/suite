        ...
        <table class="table table-striped table-condensed">
            ...
            <tbody>
                @foreach ($billings as $billing)
                    <tr>
                        <td>{{ $billing->tfa_clave }}</td>
                        <td>{{ $billing->tfa_descrip }}</td>
                        <td>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdown-catalog">
                                    <li><a href="{{ route('qore.catalogs.billings.edit', $billing) }}">Editar</a></li>
                                    <li><a href="#" class="option-delete" data-id="{{ $billing->id }}">Eliminar</a></li>
                                </ul>
                            </div>
                        </td>
                    </tr>
