...
@section('html-title')
    Qore - Pedimentos y Consolidados
@endsection
...
@section('breadcrumb')
    ...
    <li>Pedimentos y Consolidados</li>
@endsection
        ...
        <div class="col-sm-8">
            <div class="panel panel-default">
                <div class="panel-body">
                    @include('Qore.catalogs.consolids.tabs')
                </div>
            </div>
            <div class="panel panel-default">
                <div class="panel-body">
                    @include('Qore.catalogs.consolids.grid')
                </div>
            </div>
        </div>
    </div>

    {!! Form::open(['route' => ['qore.catalogs.consolids.destroy', ':CONSOLID_ID'], 'method' => 'DELETE', 'id' => 'form_delete']) !!}
    {!! Form::close() !!}
@endsection
...
@section('scripts')
    ...
    $(".option-delete").click(function(e){
        ...
        var url = form.attr('action').replace(':CONSOLID_ID', aduana);
