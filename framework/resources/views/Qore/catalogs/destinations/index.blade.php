        ...
        <div class="col-sm-8">
            <div class="panel panel-default">
                <div class="panel-body">
                    @include('Qore.catalogs.destinations.tabs')
                </div>
            </div>
            <div class="panel panel-default">
                <div class="panel-body">
                    @include('Qore.catalogs.destinations.grid')
                </div>
            </div>
        </div>
    </div>

    {!! Form::open(['route' => ['qore.catalogs.destinations.destroy', ':DESTINATION_ID'], 'method' => 'DELETE', 'id' => 'form_delete']) !!}
    {!! Form::close() !!}
@endsection
...
@section('scripts')
    ...
    $(".option-delete").click(function(e){
        ...
        var url = form.attr('action').replace(':DESTINATION_ID', aduana);
