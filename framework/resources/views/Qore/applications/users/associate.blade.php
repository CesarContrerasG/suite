...
@section('html-title')
    Qore - Acceso de Usuarios a Aplicaciones
@endsection
...
{!! Form::open(['route' => ['qore.applications.users.active', \Hashids::encode($user->id)], 'method' => 'POST', 'role' => 'form', 'id' => 'form_associate_user']) !!}
