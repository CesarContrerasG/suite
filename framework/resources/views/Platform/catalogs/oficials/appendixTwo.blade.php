...
@section('breadcrumb')
    ...
    <li>Apendice 02 (Clave de Pedimentos)</li>
@endsection
                    ...
                    <div class="panel-heading">
                        <div class="widget-title widget-title-green">
                            <div class="flex-box">
                                ...
                                <div>
                                    <h3>Clave de Pedimentos</h3>
                                    <p>Correspondiente al Apendice 02 del Anexo 22</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="panel-body">
                        ...
                        <table class="table table-striped table-datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th>{{ $clave->id }}</th>
                                    <th>{{ $clave->cpe_clave }}</th>
                                    <th>{{ $clave->cpe_descrip }}</th>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
