...
@section('breadcrumb')
    ...
    <li>Apendice 09 (Regularizaciones y Restricciones no Arancelarias)</li>
@endsection
                    ...
                    <div class="panel-heading">
                        <div class="widget-title widget-title-green">
                            <div class="flex-box">
                                ...
                                <div>
                                    <h3>Regularizaciones y Restricciones no Arancelarias</h3>
                                    <p>Correspondiente al Apendice 09 del Anexo 22</p>
                                </div>
                            </div>
                        </div>
                    </div>
