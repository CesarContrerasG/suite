...
@section('breadcrumb')
    ...
    <li>Apendice 10 (Tipos de Contenedores y Vehiculos de Transporte)</li>
@endsection
                    ...
                    <div class="panel-heading">
                        <div class="widget-title widget-title-green">
                            <div class="flex-box">
                                ...
                                <div>
                                    <h3>Tipos de Contenedores y Vehiculos de Transporte</h3>
                                    <p>Correspondiente al Apendice 10 del Anexo 22</p>
                                </div>
                            </div>
                        </div>
                    </div>
